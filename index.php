    ...
    <section id="bajada-inicio" class="box fwidth">
        ...
        <div class="container">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-left">
                <h1>Somos un grupo profesionales del área social que compartimos la inquietud de realizar acciones en pro de los derechos humanos y de los niños, así como también el de nuestros funcionarios, sustentándolos en el buen trato, permitiendo el adecuado ejercicio de nuestras profesiones, reflejado en la entrega de un servicio idóneo a nuestros usuarios, implementando nuevas visiones a nuestras políticas públicas que se sostengan en la calidad humana hacia los profesionales y lo que ellos entreguen a las personas partícipes de nuestro proyecto. </h1>
            </div>
        </div>
        <!--container contenido-->
